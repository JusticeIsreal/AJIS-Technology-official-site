...
function Banner() {
  return (
    <div className="website-banner-main-con banner-main-con">
      ...
      <div className="banner-text">
        <h2 className="banner-heading-table">WEBSITE DEVELOPEMENT</h2>
        <h2 className="banner-heading-mobile-desktop">WEBSITE DEVELOPEMENT</h2>
        <p>
